...
\vspace{5pt}
  \resumeSubHeadingListStart
    \resumeSubheading
      {WCB Robotics Pvt Ltd}{Hyderabad, India}{}{}
      \vspace{-1.2cm}
     \resumeSubheading
      {}{}{\underline{Design Engineer}}{July 2022 -- May 2023}
      \begin{itemize}[leftmargin=0.01in]
        \item[]  \textbf{RF Transceiver board for Radio controller of robot}
            \begin{itemize}\setlength{\itemsep}{0pt}\setlength{\parskip}{0pt}\vspace{-0.3em}
                ...
                \item[$\bullet$] Designed and implemented a custom SPI driver for the CC2500 transceiver, offering an abstraction layer that simplified access to core functionality.
        ...
        \vspace{-0.6cm}
        \resumeSubheading
        {}{}{\underline{Associate Design Engineer}}{July 2021 -- June 2022}
