...
\section{Projects}
  \resumeSubHeadingListStart
    ...
    % \vspace{-0.3cm}
    % \resumeSubheadingP
    % {Implementation of a MIPS pipelined datapath}{March 2020 - April 2020}
    % \begin{itemize}\setlength{\itemsep}{0pt}\setlength{\parskip}{0pt}\vspace{-0.2cm}
    %         \item Conceptualization and implementation of a \textbf{5-stage MIPS pipelined} processor in verilog which was able to detect and remedy structural, control, and data hazards for \emph{sub}, \emph{add}, \emph{or}, \emph{and} and \emph{beq} instructions.
    %     \end{itemize}
    \vspace{-0.3cm}
    \resumeSubheadingP
