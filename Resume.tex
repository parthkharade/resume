...
\begin{table}[!htb]
  \begin{tabular} { m{3.1cm} | m{15cm} }
    ...
    % {Hardware}            & {\: PCB Schematic and Layout, Circuit Design, EAGLE}\\
...
\vspace{-0.3cm}
  \begin{itemize}[leftmargin=0.3in]\setlength{\itemsep}{0pt}\setlength{\parskip}{0pt}\vspace{-0.1em}
    ...
    \item[$\bullet$] Designed a modular SPI driver in C for the CC2500 RF transceiver, implementing FHSS and antenna diversity to enhance noise immunity and ensure reliable long-range communication up to 1000 meters.  
    \item[$\bullet$] Wrote structured application code in C to handle various states of the transceiver system, such as advertising, channel synchronisation and packet processing.
    ...
    \item[$\bullet$] Wrote I2C drivers and developed firmware for the pressure senseor, implementing timeout detection and recovery mechanisms to ensure safe and reliable operation of the closed-loop pressure control system.  
...
\resumeSubheadingP
{Retro Arcade Game \textbar{ } Bluetooth Low Energy}{}
\begin{itemize}[leftmargin=0.3in]\setlength{\itemsep}{0pt}\setlength{\parskip}{0pt}\vspace{-0.2cm}
  \item[$\bullet$] Developed 'Boulder Bash', a retro arcade console game using Bluetooth Low Energy (BLE) and custom GATT services for data exchange between a energy-efficient wireless joystick and console with a dot matrix display. 
\end{itemize}
\vspace{-0.3cm}
% %
% \resumeSubheadingP
