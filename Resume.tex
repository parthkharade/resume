...
\begin{itemize}[leftmargin=0.01in]\setlength\itemsep{-3pt}
 ...
 %        \item[$\bullet$] Developed a two-PCB (rigid +flex) arrangement for orientation and differential pressure sensing, with BMP388 and BNO055 sensors. This was vital for maintaining secure suction and precise orientation on vertical surfaces.
  ...
  \item[]  \textbf{\emph{Data-Logging System for Housekeeping}}
    \begin{itemize}\setlength{\itemsep}{0pt}\setlength{\parskip}{0pt}\vspace{-0.3em}
...
%---------------------------------------------------------------------%
% \resumeSubheading
% {CU Boulder}{Teaching Assistant - Embedded System Design}{January 2024 - December 2024}
% \vspace{-0.3cm}
...
\begin{itemize}[leftmargin=0.3in]\setlength{\itemsep}{0pt}\setlength{\parskip}{0pt}\vspace{-0.2cm}
  ...
  \item[$\bullet$] Evaluated performance by benchmarking execution time and comparing it against standard C implementations.
\end{itemize}
\vspace{-0.3cm}
...
% \resumeSubheadingP
% {Driver Assistance System \textbar{ } Real-Time Embedded Systems }{April 2024 - May 2024}
% \begin{itemize}[leftmargin=0.3in]\setlength{\itemsep}{0pt}\setlength{\parskip}{0pt}\vspace{-0.2cm}
%   \item[$\bullet$] Prototyped a driver assistance system using RTLinux. Synchronized multiple tasks such as frame capture, lane departure, human detection, running on different cores using cyclic rate monotonic schedulers and semaphores.
% \end{itemize}
% \vspace{-0.2cm}
